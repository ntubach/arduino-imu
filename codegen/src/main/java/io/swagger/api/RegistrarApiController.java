...
public class RegistrarApiController implements RegistrarApi {
    ...
    public ResponseEntity<List<Student>> registrarGet(@NotNull @Parameter(in = ParameterIn.QUERY, description = "Course Number" ,required=true,schema=@Schema()) @Valid @RequestParam(value = "courseNumber", required = true) Integer courseNumber) {
        String accept = request.getHeader("Accept");
    ...
    public ResponseEntity<Registrar> registrarPut(@NotNull @Parameter(in = ParameterIn.QUERY, description = "Course Number" ,required=true,schema=@Schema()) @Valid @RequestParam(value = "courseNumber", required = true) Integer courseNumber,@NotNull @Parameter(in = ParameterIn.QUERY, description = "Student ID" ,required=true,schema=@Schema()) @Valid @RequestParam(value = "id", required = true) Integer id) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
        ...
        return new ResponseEntity<Registrar>(HttpStatus.NOT_IMPLEMENTED);
    }
